javascript:(function() {
    ...
    const initialize = async () => {
        try {
            const checkboxJson = await fetchJSON('https://raw.githubusercontent.com/cho-gachizei/my-scripts/main/checkbox.json');
            ...
            const radioJson = await fetchJSON('https://raw.githubusercontent.com/cho-gachizei/my-scripts/main/radiobottom.json');
            ...
            const dropdownJson = await fetchJSON('https://raw.githubusercontent.com/cho-gachizei/my-scripts/main/pulldown.json');
            ...
            const textboxJson = await fetchJSON('https://raw.githubusercontent.com/cho-gachizei/my-scripts/main/textbox.json');
